...
public class OperateExcel {
	...
	public static void createExcelFile(String excelFileName) {
		try {
			...
			WritableFont wf_color = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
			...
			// 合并单元格
			WritableFont wf_merge = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
