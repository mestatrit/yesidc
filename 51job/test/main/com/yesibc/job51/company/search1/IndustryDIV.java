...
public class IndustryDIV {
	...
	public static String[][] IND_ARRAY = { { "01", "计算机软件" }, { "37", "计算机硬件" }, { "38", "计算机服务(系统、数据服务，维修)" },
			...
			{ "44", "家具/家电/工艺品/玩具/珠宝" }, { "45", "办公用品及设备" }, { "14", "机械/设备/重工" }, { "33", "汽车及零配件" },
			...
			{ "59", "外包服务" }, { "52", "检测，认证" }, { "18", "法律" }, { "23", "教育/培训" }, { "24", "学术/科研" }, { "11", "餐饮业" },
	...
	public static IElement getIndDIV() {
		List<IElement> ies = JobSupport.getElementsByTxt(JobMain.getDoc().getAll().tags("DIV"), ind_tags);
		if (ies.size() != 1) {
	...
	public static IElement getIndCHKElement(String[] txts) {
