...
<html>
	...
	<body onload="waitLoad(1);freshIframe()">
		...
		<div id="content1" style="display: ">
			...
			0-default=OK;1-search list;2-company page list;3-company list;4-job
			list.
			<br />
			<s:textfield key="fromDBorFile" value="db" />
			<br />
			<br />
...
　　{
		...
		iframe1.document.getElementById("clawer51JobSearch_fromDBorFile").value=document.getElementById("fromDBorFile").value;
