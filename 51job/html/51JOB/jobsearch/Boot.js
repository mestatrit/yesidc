...
N2Initializer.prototype.runThisWhen  = function(sWhen, fFn, sComment){
	if((typeof(fFn) != 'function') || fFn == null) 
		return false;
...
document.write('<link href="/jobsearch/scripts/area/pop.css" type="text/css" rel="stylesheet">');
goN2LibMon.monitorLoad ("utilities");
goN2LibMon.monitorLoad ("events");
goN2LibMon.monitorLoad ("simplePopover");
document.write('<script language="javascript" src="/jobsearch/scripts/area/n2CoreLibs-utilities.js" type="text/javascript"></script>'+'<script language="javascript" src="/jobsearch/scripts/area/n2CoreLibs-events.js" type="text/javascript"></script>'+'<script language="javascript" src="/jobsearch/scripts/area/n2CoreLibs-simplePopover.js" type="text/javascript"></script>'+'');
...
n2RunThisWhen(n2sRTWTBS, function(){
	...
	goN2Events.registerFeature('51job', 'oAllCatPopover', 'n2MouseOverHotspot', 'n2MouseOutHotspot');
	goN2Events.setFeatureDelays('51job',200, 400, 200);
	oAllCatPopover.initialize('AllCatPopoverDiv', 'oAllCatPopover',null,null,'below','r'); 
