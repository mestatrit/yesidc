...
comment on column TC_CONTACT_HEADER.CITY_NAME is '市名称'
comment on column TC_CONTACT_HEADER.COMPANY_NAME is '公司名称'
comment on column TC_CONTACT_HEADER.FROM_WHERE is '数据来源代码'
comment on column TC_CONTACT_HEADER.FROM_WHERE_NAME is '数据来源'
comment on column TC_CONTACT_HEADER.DEFAULT_NAME is '中文名称'
comment on column TC_CONTACT_HEADER.DEFAULT_NAME_EN is '英文名称'
comment on column TC_CONTACT_HEADER.address1 is '地址一'
comment on column TC_CONTACT_HEADER.address2 is '地址二'
comment on column TC_CONTACT_HEADER.postcode1 is '邮编一'
comment on column TC_CONTACT_HEADER.postcode2 is '邮编二'
