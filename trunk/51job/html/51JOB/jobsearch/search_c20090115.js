...
function openSubLayer1( layerId , id ) {
	//alert("ttttt="+layerId)
}
...
function openSubLayer( e , layerId , id ) {
	...
	//alert("A1 innerHTML="+sobj.innerHTML);
	fallowMouse( e , sobj );
	...
	//alert("A2 outerHTML="+sobj.outerHTML);
}
...
function chxClk( obj ) {
	//alert("AinchxClkner="+obj.innerHTML)
	obj.checked = !obj.checked;
	//alert("Aobjddsa=" + obj.id + ",obj="+obj.type);
}

function chxOrSpnClkFunc( obj ) {

	//alert("Aobjddsa=" + obj.id + ",obj="+obj.type);
	//alert("Aobjd2ds3a=" + obj.srcElement);
