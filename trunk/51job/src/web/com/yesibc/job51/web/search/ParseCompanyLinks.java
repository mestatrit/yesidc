...
public class ParseCompanyLinks {
	...
	public static void parseCompanyLinks(ProcessContext processContext) {
		...
		log.debug(processContext.getLogTitle() + "Check Company List!Time is " + (System.currentTimeMillis() - l));
		l = System.currentTimeMillis();

		CompanyJobContext.putCompanyLinks2Context(processContext);

		log.debug(processContext.getLogTitle() + "Parse company  to context!Time is "
